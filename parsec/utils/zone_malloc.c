...
void zone_free(zone_malloc_t *gdata, void *add)
{
    ...
    printf("zone_free current tid %d segment %p prev tid %d segment %p next tid %d segment %p\n",
            current_tid, current_segment, prev_tid, prev_segment, next_tid, next_segment);
